...
- Active plan: [specs/010-docs-plugin-gallery/plan.md](specs/010-docs-plugin-gallery/plan.md)
- Feature spec: [specs/010-docs-plugin-gallery/spec.md](specs/010-docs-plugin-gallery/spec.md)
- ⚠️ **010 is BLOCKED on plugin-rendering-parity work**: see [specs/010-docs-plugin-gallery/BLOCKED.md](specs/010-docs-plugin-gallery/BLOCKED.md). M4 plugin partials emit invisible / incomplete output when rendered via GitHub's `<img src=...svg>` path. Foundation (spec + tools + script) is committed; sample generation is deferred until the rendering work lands.
