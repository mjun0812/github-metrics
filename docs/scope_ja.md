...
各プラグインの入出力 / 必要スコープは [`docs/plugins/`](plugins/) の自動生成ページを参照。データ取得方法 (REST / GraphQL / HTML スクレイピング / ローカル計算) の一覧は [`github-api-data-sources.md`](github-api-data-sources_ja.md) を参照。
