...
| プラグイン (採用 20) | languages (+recent+indepth), activity, achievements, repositories, isocalendar, calendar, habits, stars, topics, starlists, people, notable, contributors, reactions, sponsors, sponsorships, stargazers, traffic (projects は #670 で廃止) | 8 個の GitHub 系不採用、10 個の社外 API 系不採用、9 個の community 不採用 |
