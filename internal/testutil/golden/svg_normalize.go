...
//
// The output is suitable for MD5-comparison golden files. Used
// internally by CompareSVG; exported so callers that need raw
// normalization (e.g., diffing two in-flight SVGs without a golden
// file) can reuse the helper.
