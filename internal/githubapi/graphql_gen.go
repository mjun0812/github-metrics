...
type UserIsocalendarResponse struct {
	User *UserIsocalendarUser `json:"user"`
}

// GetUser returns UserIsocalendarResponse.User, and is useful for accessing the field via an interface.
func (v *UserIsocalendarResponse) GetUser() *UserIsocalendarUser { return v.User }

// UserIsocalendarUser includes the requested fields of the GraphQL type User.
type UserIsocalendarUser struct {
	ContributionsCollection *UserIsocalendarUserContributionsCollection `json:"contributionsCollection"`
}

// GetContributionsCollection returns UserIsocalendarUser.ContributionsCollection, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUser) GetContributionsCollection() *UserIsocalendarUserContributionsCollection {
	return v.ContributionsCollection
}

// UserIsocalendarUserContributionsCollection includes the requested fields of the GraphQL type ContributionsCollection.
type UserIsocalendarUserContributionsCollection struct {
	ContributionCalendar *UserIsocalendarUserContributionsCollectionContributionCalendar `json:"contributionCalendar"`
}

// GetContributionCalendar returns UserIsocalendarUserContributionsCollection.ContributionCalendar, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollection) GetContributionCalendar() *UserIsocalendarUserContributionsCollectionContributionCalendar {
	return v.ContributionCalendar
}

// UserIsocalendarUserContributionsCollectionContributionCalendar includes the requested fields of the GraphQL type ContributionCalendar.
type UserIsocalendarUserContributionsCollectionContributionCalendar struct {
	Weeks []*UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek `json:"weeks"`
}

// GetWeeks returns UserIsocalendarUserContributionsCollectionContributionCalendar.Weeks, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendar) GetWeeks() []*UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek {
	return v.Weeks
}

// UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek includes the requested fields of the GraphQL type ContributionCalendarWeek.
type UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek struct {
	FirstDay         string                                                                                                                                `json:"firstDay"`
	ContributionDays []*UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay `json:"contributionDays"`
}

// GetFirstDay returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek.FirstDay, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek) GetFirstDay() string {
	return v.FirstDay
}

// GetContributionDays returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek.ContributionDays, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeek) GetContributionDays() []*UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay {
	return v.ContributionDays
}

// UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay includes the requested fields of the GraphQL type ContributionCalendarDay.
type UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay struct {
	Date              string `json:"date"`
	ContributionCount int    `json:"contributionCount"`
	Weekday           int    `json:"weekday"`
	Color             string `json:"color"`
...
// GetDate returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay.Date, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay) GetDate() string {
	return v.Date
}

// GetContributionCount returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay.ContributionCount, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay) GetContributionCount() int {
	return v.ContributionCount
}

// GetWeekday returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay.Weekday, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay) GetWeekday() int {
	return v.Weekday
}

// GetColor returns UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay.Color, and is useful for accessing the field via an interface.
func (v *UserIsocalendarUserContributionsCollectionContributionCalendarWeeksContributionCalendarWeekContributionDaysContributionCalendarDay) GetColor() string {
	return v.Color
}
...
// __UserIsocalendarInput is used internally by genqlient
type __UserIsocalendarInput struct {
	Login string    `json:"login"`
	From  time.Time `json:"from"`
	To    time.Time `json:"to"`
}

// GetLogin returns __UserIsocalendarInput.Login, and is useful for accessing the field via an interface.
func (v *__UserIsocalendarInput) GetLogin() string { return v.Login }

// GetFrom returns __UserIsocalendarInput.From, and is useful for accessing the field via an interface.
func (v *__UserIsocalendarInput) GetFrom() time.Time { return v.From }

// GetTo returns __UserIsocalendarInput.To, and is useful for accessing the field via an interface.
func (v *__UserIsocalendarInput) GetTo() time.Time { return v.To }
...
// The query executed by UserIsocalendar.
const UserIsocalendar_Operation = `
query UserIsocalendar ($login: String!, $from: DateTime!, $to: DateTime!) {
	user(login: $login) {
		contributionsCollection(from: $from, to: $to) {
			contributionCalendar {
				weeks {
...
func UserIsocalendar(
	ctx_ context.Context,
	client_ graphql.Client,
	login string,
	from time.Time,
	to time.Time,
) (data_ *UserIsocalendarResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "UserIsocalendar",
		Query:  UserIsocalendar_Operation,
		Variables: &__UserIsocalendarInput{
			Login: login,
			From:  from,
			To:    to,
		},
